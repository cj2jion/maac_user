...
class Actor(object):
    def __init__(self, sess, name,arglist, n_features, n_actions):
        self.sess = sess
        with tf.variable_scope("a_trainer"+name, reuse=tf.AUTO_REUSE):
            with tf.variable_scope("a_inputs"):
...
class Critic(object):
    def __init__(self, sess, arglist, n_features):
        self.sess = sess
        with tf.variable_scope("c_trainer", reuse=tf.AUTO_REUSE):
...
class AgentTrainer(object):
    def __init__(self, name,sess, n_features, n_actions,n_single_features, arglist):
        self.name=name
        self.actor=Actor(sess, name, arglist, n_features=n_single_features, n_actions=n_actions)
